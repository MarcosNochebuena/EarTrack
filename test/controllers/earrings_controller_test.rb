...
class EarringsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create earring' do
    assert_difference('Earring.count') do
      post earrings_url,
           params: { earring: { age: @earring.age, earring: @earring.earring, gender: @earring.gender,
                                key_id_id: @earring.key_id_id, status: @earring.status } }
    end
